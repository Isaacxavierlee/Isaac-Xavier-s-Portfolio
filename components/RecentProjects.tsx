...
const RecentProjects = () => {
  return (
    <div className="py-20" id="projects">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-8 sm:gap-16 mt-10">
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div key={id} className="lg:min-h-[32.5rem] h-[25rem] flex items-center justify-center sm:w-96 w-[80vw] text-white">
            <PinContainer title={title} href={link}>
              ...
              <p className="lg:text-xl lg:font-normal font-light text-sm lg:text-base line-clamp-3" style={{ color: "#BEC1DD", margin: "1vh 0" }}>
                {des}
              </p>
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                ...
                <div className="flex justify-center items-center">
                  <a href={link} target="_blank" rel="noopener noreferrer" className="flex text-sm md:text-xs lg:text-xl text-purple hover:underline">View Live Site</a>
